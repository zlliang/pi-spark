...
export function loadConfig<Field extends ConfigField>(ctx: ExtensionContext, field: Field, fileName: string = "credits.json"): ConfigValue<Field> | undefined {
  ...
  ctx.ui.notify(`Invalid credits config: ${message}`, "error");
