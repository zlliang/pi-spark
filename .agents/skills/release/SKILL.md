---
name: release
description: Releases a new version of pi-spark via Release Please. Use when asked to release, publish a new version, or to release a specific version (e.g., 0.10.1) or bump type (patch, minor, major). Drives the Release Please GitHub Action, optionally records a Release-As override commit, then merges and pulls the auto-generated release PR.
---
